...
class NpmController extends Controller {
  ...
  async getPackageVersions() {
    ...
    // 拼装页面路径
    actPath = this.config.legoConfigV2.LegoActPath + '/development/' + actPath + '/';
  ...
  async updatePackageVersion() {
    ...
    // 拼装页面路径
    actFolder = this.config.legoConfigV2.LegoActPath + '/development/' + actFolder + '/';
    this.ctx.logger.info('更新版本号');
    // 读取活动目录下的package.json文件
