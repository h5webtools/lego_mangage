define(function (require, exports, module) {
    ...
    var defaultTplEdit = 'http:/template/new/jybswitchlist/edit.html';
    ...
    _Class.prototype.rebuildShowComponent = function () {
        ...
        // if (window.location.href.indexOf('martpagemakerv2') > 0) {
        //     tplurl = tplurl.replace('/martpagemaker/template/new/', '/martpagemakerv2/template/v2/');
        // }
