define(function (require, exports, module) {
  ...
  function formatPrice(price, fixed) {
    ...
    if (+price < 0 || isNaN(price)) {
      ...
      price = (price / 100).toFixed(fixed);
      const num = price.split('.');
      const integer = toThousands(num[0]);
      const decimal = num[1];
  ...
  function _register(opt) {
    Vue.component("productlist", {
      ...
      filters: {
        filterAmount: function(price, fixed) {
            return formatPrice(price, fixed);
        }
      },
      mounted: function () {
        console.log("mounted");
      ...
      methods: {
        ...
        // formatPrice: function (price, fixed) {
        //   price = +price;
        //   fixed = fixed || 2;
        //   if (+price < 0 || isNaN(price)) {
        //     return '--';
