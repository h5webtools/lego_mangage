define(function(require, exports, module){
        ...
        var vueComponent = require("./jyb.vue.jybactrolling");
        var Factory = require('./jyb.vue.edit.factory');
        var defaultTplEdit = 'http:/template/new/jybactrolling/edit.html';
        ...
        data: {
            ...
            "npmversion":"",
            "npmversionArr":[],
            "npmname":"@lego/jybactrolling",
        },
        watch: ['data.styleKey' , 'data.actcmd', 'data.actid', 'data.bgcolor', 'data.toppadding' , 
                'data.downpadding'  , 'data.wordscolor' ]
            ...
            this.domEdit = new Vue({
                ...
                methods: {
                    ...
                    selectNpmVersion: function () { /* npm管理 */
                        console.info("切换理财产品组件的版本是", this.obj.data.npmversion);
                        ...
                        moduleDataCenter.updataversion(this.obj.data.npmversion, '@lego/jybactrolling', path, function () {
    ...
    exports.getComponent = function (config, callback) {
        ...
        if (component.config.obj.actcmd) {
            component.config.obj.actcmd = "";
