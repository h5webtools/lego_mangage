define(function(require, exports, module){
        ...
        var defaultTplEdit = 'http:/template/new/jybfinanciallist/edit.html';
        ...
        watch: ['data.styleKey' , 'data.prddes', 'data.bgcolor', 'data.conwidth', 'data.toppadding' , 
                'data.downpadding'  , 'data.finaItem' ]
        ...
        _Class.prototype._appendEditDom = function() {
            ...
            this.domEdit = new Vue({
                ...
                methods: {
                    ...
                    addFinaItem: function() {
                        this.obj.data.finaItem.push({
                            topDes: "",
                            des1:"",
                            des2:"",
                            des3:"",
                    ...
                    deleteFinaItem: function(index) {
                        var deleteItem = this.obj.data.finaItem.splice(index - 0, 1);
                    },
    ...
    exports.getComponent = function (config, callback) {
        ...
        if (component.config.obj.finaItem) {
            component.config.obj.finaItem = [];
