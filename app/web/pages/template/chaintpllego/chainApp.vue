<template>
  <div>
    <div class="martop20 marleft20" v-loading="chainLoading">
...
.string-type { color: green; }
.number-type { color: darkorange; }
.boolean-type { color: blue; }
.null-type { color: magenta; }
.key-type { color: red; }
.ui-ta-r{
  text-align: right;
}
