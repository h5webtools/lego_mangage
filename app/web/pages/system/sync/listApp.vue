...
<div>
    <div class="martop20">
      ...
      <el-table :header-cell-style="{'color': '#333'}" :data="tableData" v-loading="listLoading" stripe border highlight-current-row>
        ...
        <el-table-column prop="is_all" label="是否全量"></el-table-column>
        <el-table-column prop="syn_time" label="同步日期"></el-table-column>
        <el-table-column prop="create_time_field" label="创建时间"></el-table-column>
        <el-table-column prop="update_time_field" label="更新时间"></el-table-column>
        <el-table-column  label="操作" width="240">
          <template slot-scope="scope">
            <el-button @click="editSync(scope.row)" type="text" size="small">编辑</el-button>
            <el-switch v-model="scope.row.is_syn" active-color="#13ce66"  active-value="1" inactive-value="0" inactive-color="#ff4949" @change="toggleItemStatus(scope.row)">
            </el-switch>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog title="新增/编辑配置" :visible.sync="dialogVisible">
      <el-form v-loading="dialogLoading"  ref="systemData" label-width="150px" :rules="rules" :model="systemData">
        <el-form-item label="表名" required prop="table_name">
          <el-input placeholder="表名"  v-model="systemData.table_name"></el-input>
        </el-form-item>
        <el-form-item label="DB连接名称" required prop="db_config">
          <el-input placeholder="db_config"  v-model="systemData.db_config"></el-input>
        </el-form-item>
        <el-form-item label="远程DB连接名称" required prop="remote_db_config">
          <el-input placeholder="remote_db_config" v-model="systemData.remote_db_config"></el-input>
        </el-form-item>
        <el-form-item label="同步字段" required prop="field">
          <el-input placeholder="field" v-model="systemData.field"></el-input>
        </el-form-item>
        <el-form-item label="是否全量" required prop="is_all">
          <el-input placeholder="is_all" v-model="systemData.is_all"></el-input>
        </el-form-item>
        <el-form-item label="同步日期" required prop="syn_time">
          <el-input placeholder="syn_time" v-model="systemData.syn_time"></el-input>
        </el-form-item>
        <el-form-item label="创建时间" required prop="create_time_field">
          <el-input placeholder="create_time_field" v-model="systemData.create_time_field"></el-input>
        </el-form-item>
        <el-form-item label="更新时间" required prop="update_time_field">
          <el-input placeholder="update_time_field" v-model="systemData.update_time_field"></el-input>
        </el-form-item>
        <el-form-item>
