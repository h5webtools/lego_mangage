...
Component.options.__file = "/Users/chenchao/Documents/git_workspace/act_page_maker/config/app/web/pages/system/sync/listApp.vue"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_api_api_system_sync__ = __webpack_require__(313);
//
//
//
//
  ...
  methods: {
    ...
    confirmAddSync: function confirmAddSync(formName) {
      ...
      this.$refs[formName].validate(function (valid) {
        if (valid) {
          __WEBPACK_IMPORTED_MODULE_0_api_api_system_sync__["b" /* savePostSync */](_this3.systemData).then(function (jsonData) {
            console.log(jsonData);
            if (jsonData.code == 0) {
              _this3.$confirm('活动保存成功', '提示').then(function () {
                location.reload();
              });
            } else {
              _this3.$confirm('活动保存失败，请重试！', '提示');
            }
          });
        } else {
          return false;
