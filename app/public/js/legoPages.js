...
Component.options.__file = "C:\\jyb\\jyb_git\\lego_manage\\app\\web\\pages\\lego\\pages\\listApp.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-e5bcd604", Component.options)
  } else {
    hotAPI.reload("data-v-e5bcd604", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_api_api_lego_pages__ = __webpack_require__(361);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  filters: {
    filterOldPath: function filterOldPath(value) {
      return value.replace('https://cdn.jyblife.com/act/pagemaker/', '').replace(/\//, '');
    }
  },
  methods: {
    queryActPage: function queryActPage(refresh) {
      var _this = this;

      this.listLoading = true;
      __WEBPACK_IMPORTED_MODULE_0_api_api_lego_pages__["a" /* getActPages */](this.queryData).then(function (json) {
        _this.listLoading = false;
        if (json.code == 0) {
          _this.tableData = json.data.page_list;
          _this.queryData.pageOwner = json.data.current_user;
          if (refresh) {
    ...
    filterPageType: function filterPageType(row, column, value) {
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = getActPages;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_services__ = __webpack_require__(160);


function getActPages(data) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    model: {
      value: (_vm.queryData.pageOwner),
      callback: function($$v) {
        _vm.$set(_vm.queryData, "pageOwner", $$v)
      },
      expression: "queryData.pageOwner"
    }
    ...
    model: {
      value: (_vm.queryData.pageName),
      callback: function($$v) {
        _vm.$set(_vm.queryData, "pageName", $$v)
      },
      expression: "queryData.pageName"
    }
  })], 1), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "活动号："
    ...
    model: {
      value: (_vm.queryData.pageActId),
      callback: function($$v) {
        _vm.$set(_vm.queryData, "pageActId", $$v)
      },
      expression: "queryData.pageActId"
    }
    ...
    model: {
      value: (_vm.queryData.createRange),
      callback: function($$v) {
        _vm.$set(_vm.queryData, "createRange", $$v)
      },
      expression: "queryData.createRange"
    }
  })], 1), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "活动过期时间："
    ...
    model: {
      value: (_vm.queryData.expireTime),
      callback: function($$v) {
        _vm.$set(_vm.queryData, "expireTime", $$v)
      },
      expression: "queryData.expireTime"
    }
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function(props) {
        return [_c('el-form', {
        ...
        }, [_c('span', [_vm._v(_vm._s(props.row.page_editdate))])]), _vm._v(" "), _c('el-form-item', {
          attrs: {
            "label": "页面过期时间："
          }
        }, [_c('span', [_vm._v(_vm._s(props.row.page_editdate))])]), _vm._v(" "), _c('el-form-item', {
          ...
          attrs: {
            "target": "_blank",
            "href": 'https://cdnsit.jyblife.com/act/' + props.row.date_folder + '/' + props.row.page_path.replace('https://cdn.jyblife.com/act/pagemaker/', '').replace(/\//, '') + '/index.html?act_id=' + (props.row.page_act_id || '')
          }
        }, [_vm._v("https://cdnsit.jyblife.com/act/" + _vm._s(props.row.date_folder) + "/" + _vm._s(_vm._f("filterOldPath")(props.row.page_path)) + "/index.html")])]), _vm._v(" "), _c('el-form-item', {
          attrs: {
            "label": "正式环境："
          }
        }, [_c('a', {
          ...
          attrs: {
            "target": "_blank",
            "href": 'https://cdn.jyblife.com/act/' + props.row.date_folder + '/' + props.row.page_path.replace('https://cdn.jyblife.com/act/pagemaker/', '').replace(/\//, '') + '/' + 'index.html?act_id=' + (props.row.page_act_id || '')
          }
        }, [_vm._v("https://cdn.jyblife.com/act/" + _vm._s(props.row.date_folder) + "/" + _vm._s(_vm._f("filterOldPath")(props.row.page_path)) + "/index.html")])])], 1)]
      }
    }])
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function(props) {
        return [_c('a', {
          ...
          attrs: {
            "target": "_blank",
            "href": '/lego/editPage?page_id=' + props.row.page_id + '&act_id=' + (props.row.page_act_id || '')
          }
        }, [_vm._v("编辑页面")])]
      }
    }])
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-e5bcd604", module.exports)
  }
}
