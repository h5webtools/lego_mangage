  ...
  methods: {
    ...
    saveCurAct: function saveCurAct(plan_type, plan_id, index) {
      ...
      this.$confirm('你确定要修改该活动?', '提示', {
        ...
        if (!_this5.timeValidCheck(submitData.begin_at, submitData.end_at, submitData.effect_time, submitData.expire_time)) {
          _this5.$message({
            type: 'error',
    ...
    submitSubAct: function submitSubAct(formName) {
      ...
      this.$refs[formName].validate(function (valid) {
        if (valid) {
          ...
          _this7.group_id = _this7.addSubActForm.checkedUserGroups;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _vm._v(" "), (_vm.editData.data) ? _c('el-row', {
  ...
  })) : _vm._e(), _vm._v(" "), (_vm.editData.data) ? _c('el-row', {
    staticClass: "mg-tp-10",
    attrs: {
      "gutter": 20
    }
  ...
  }))], 2) : _vm._e(), _vm._v(" "), (_vm.editData.flag == 0 && _vm.editData.data) ? _c('el-row', {
    staticClass: "mg-tp-10",
    attrs: {
      "gutter": 20
    }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  })], 1) : _vm._e(), _vm._v(" "), (_vm.parentData.config.act_type != 2) ? _c('el-form-item', {
    attrs: {
      "label": "投放开始时间",
      "required": "",
      "prop": "begin_at"
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_api_api_entry_index__ = __webpack_require__(253);
  ...
  data: function data() {
    return {
      ...
      rules: {
        ...
        begin_at: [{ type: 'date', required: true, message: '请填写投放日期', trigger: 'change' }],
        end_at: [{ type: 'date', required: true, message: '请填写下线日期', trigger: 'change' }],
  ...
  methods: {
    ...
    deleteIconConfig: function deleteIconConfig(index) {
      ...
      this.$confirm('确认删除该配置？', '提示', {
        ...
        var submitData = _this5.ruleForm.pictures[index];
        if (!submitData.plan_id) {
          _this5.deleteAppointCon();
        } else {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('el-row', {
    ...
    return _c('el-tab-pane', {
      ...
      attrs: {
        ...
        "editData": {
          a: item.configArr.current_entrance,
          b: 1
        }
      }
    ...
    model: {
      value: (_vm.addSubActForm.act_type),
      callback: function($$v) {
        _vm.$set(_vm.addSubActForm, "act_type", $$v)
      },
      expression: "addSubActForm.act_type"
    }
  }, [_vm._v("候补活动")]), _vm._v(" "), _c('el-radio', {
    attrs: {
      "label": "2"
    },
    model: {
  ...
  }, [_vm._v("默认活动")])], 1), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "活动号：",
      "label-width": _vm.formLabelWidth
    }
