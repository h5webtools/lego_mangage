...
Component.options.__file = "C:\\jyb\\jyb_git\\lego_manage\\app\\web\\pages\\lego\\cstyles\\listApp.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-cfa17982", Component.options)
  } else {
    hotAPI.reload("data-v-cfa17982", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    ...
    return {
      ...
      rules: {
        image: [{ required: true, message: "请输入demo图片地址", trigger: "blur" }],
        tpl_url: [{ required: true, message: "请输入样式模板地址", trigger: "blur" }],
        com_desc: [{ required: true, message: "请输入样式描述", trigger: "blur" }]
      }
    };
  },
  ...
  methods: {
    queryFilterList: function queryFilterList(refreshPage) {
      ...
      __WEBPACK_IMPORTED_MODULE_0_api_api_lego_component__["b" /* getSelectedComponentStyles */](this.comid).then(function (jsonData) {
        _this.listLoading = false;
        _this.tableData = jsonData.data;
      });
    },
    ...
    confirmAddCom: function confirmAddCom(formName) {
      ...
      this.$refs[formName].validate(function (valid) {
        if (valid) {
          var isUpdate = !!_this2.templateData.id;
          var method = isUpdate ? __WEBPACK_IMPORTED_MODULE_0_api_api_lego_component__["f" /* updateComponentStyle */] : __WEBPACK_IMPORTED_MODULE_0_api_api_lego_component__["d" /* saveComponentStyle */];
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('el-button', {
  ...
  }), _vm._v("新增样式")]), _vm._v(" "), _c('el-table', {
    directives: [{
      name: "loading",
      rawName: "v-loading",
    ...
    scopedSlots: _vm._u([{
      key: "default",
      fn: function(props) {
        return [_c('span', [_vm._v(_vm._s(props.row.tpl_url.replace('http://act.jtjr.com/martpagemaker', '')))])]
      }
    }])
  }), _vm._v(" "), _c('el-table-column', {
    attrs: {
    ...
    attrs: {
      "placeholder": "/template/new/组件key/show.1.html"
    },
    model: {
      value: (_vm.templateData.tpl_url),
      callback: function($$v) {
        _vm.$set(_vm.templateData, "tpl_url", $$v)
      },
      expression: "templateData.tpl_url"
    }
    ...
    attrs: {
      "placeholder": "demo图片地址"
    },
    model: {
      value: (_vm.templateData.image),
      callback: function($$v) {
        _vm.$set(_vm.templateData, "image", $$v)
      },
      expression: "templateData.image"
    }
  })], 1), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "描述",
    ...
    attrs: {
      "placeholder": "组件样式功能概要"
    },
    model: {
      value: (_vm.templateData.com_desc),
      callback: function($$v) {
        _vm.$set(_vm.templateData, "com_desc", $$v)
      },
      expression: "templateData.com_desc"
    }
  })], 1), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "优先级"
    ...
    attrs: {
      "placeholder": "默认100,越小越靠前"
    },
    model: {
      value: (_vm.templateData.priority),
      callback: function($$v) {
        _vm.$set(_vm.templateData, "priority", $$v)
      },
      expression: "templateData.priority"
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-cfa17982", module.exports)
  }
}
