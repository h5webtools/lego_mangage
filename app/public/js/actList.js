...
Component.options.__file = "/Users/chenchao/Documents/git_workspace/act_page_maker/config/app/web/pages/act/list/listApp.vue"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_api_api_act_list__ = __webpack_require__(243);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      isAdmin: __WEBPACK_IMPORTED_MODULE_1_assets_js_util__["b" /* getCookie */]('auths') && __WEBPACK_IMPORTED_MODULE_1_assets_js_util__["b" /* getCookie */]('auths').indexOf("0") > -1, //管理员
      isTester: __WEBPACK_IMPORTED_MODULE_1_assets_js_util__["b" /* getCookie */]('auths') && __WEBPACK_IMPORTED_MODULE_1_assets_js_util__["b" /* getCookie */]('auths').indexOf("1") > -1, //测试
      // isTester:util.getCookie('auths').indexOf("2") > -1, //运营
      // isTester:util.getCookie('auths').indexOf("3") > -1, //开发
      userAuths: __WEBPACK_IMPORTED_MODULE_1_assets_js_util__["b" /* getCookie */]('auths'), // 
      userIds: __WEBPACK_IMPORTED_MODULE_1_assets_js_util__["b" /* getCookie */]('user_id'), // 
      tableData: [],
      logData: {}, //日志流水
      listLoading: true,
      total: 0
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [(_vm.showSubRoute) ? _c('router-view') : _c('div', {
    ...
    model: {
      value: (_vm.queryData.expire_time),
      callback: function($$v) {
        _vm.$set(_vm.queryData, "expire_time", $$v)
      },
      expression: "queryData.expire_time"
    }
  })], 1), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "创建时间："
    ...
    model: {
      value: (_vm.queryData.create_time),
      callback: function($$v) {
        _vm.$set(_vm.queryData, "create_time", $$v)
      },
      expression: "queryData.create_time"
    }
  })], 1), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "结束时间："
    ...
    model: {
      value: (_vm.queryData.end_time),
      callback: function($$v) {
        _vm.$set(_vm.queryData, "end_time", $$v)
      },
      expression: "queryData.end_time"
    }
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function(props) {
        return [_c('el-button', {
          ...
          staticClass: "btnchains",
          attrs: {
            "target": "_blank",
            "href": 'chain.html?act_id=' + props.row.act_id + '&status=' + props.row.status
          }
        }, [_vm._v("副本模板 "), _c('i', {
          ...
          attrs: {
            "target": "_blank",
            "href": 'chain.html?tplflag=realtpl&act_id=' + props.row.act_id + '&status=' + props.row.status
          }
        }, [_vm._v("正式模板 "), _c('i', {
          staticClass: "el-icon-arrow-right"
        })])]), _vm._v(" "), _c('el-table', {
          staticClass: "ui-mt-20",
          attrs: {
            "data": [props.row],
            "stripe": "",
            "border": "",
    ...
    scopedSlots: _vm._u([{
      key: "default",
      fn: function(props) {
        return [_c('span', [_vm._v(_vm._s(_vm.deadlineNotify(props.row)))])]
      }
    }])
  }), _vm._v(" "), _c('el-table-column', {
    attrs: {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function(props) {
        return [_c('el-dropdown', {
        ...
        }, [_vm._v("编辑活动")])], 1), _vm._v(" "), _c('el-dropdown-item', {
          attrs: {
            "divided": ""
          }
        }, [_c('router-link', {
        ...
        }, [_vm._v("规则配置")])], 1), _vm._v(" "), _c('el-dropdown-item', {
          attrs: {
            "divided": ""
          }
        }, [_c('div', {
          on: {
            "click": function($event) {
              _vm.manual(props.row)
            }
          }
        }, [_vm._v("同步配置")])]), _vm._v(" "), (props.row.is_lego == '1') ? _c('el-dropdown-item', {
          attrs: {
            "divided": ""
          }
        }, [_c('a', {
          attrs: {
            "href": 'http://172.16.1.10:3001/interpage.html?page_id=' + props.row.pageids + '&act_id=' + props.row.crypt
          }
          ...
          on: {
            "click": function($event) {
              _vm.showTestResultDialog(props)
            }
          }
          ...
          on: {
            "click": function($event) {
              _vm.submitApprove(props)
            }
          }
        }, [_vm._v("提交审批")])], 1) : _vm._e(), _vm._v(" "), (props.row.status == 6 && (props.row.creator == _vm.userIds || _vm.isAdmin || props.row.isRevisability)) ? _c('el-dropdown-item', {
          attrs: {
            "divided": ""
          }
        }, [_c('el-button', {
    ...
    on: {
      "click": function($event) {
        _vm.submitTestResult('testResult')
      }
    }
  }, [_vm._v("确认提交")])], 1)], 1)], 1)], 1)
},staticRenderFns: []}
