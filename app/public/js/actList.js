...
Component.options.__file = "/Users/hilter/work/lego_manage/app/web/pages/act/list/listApp.vue"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_api_api_act_list__ = __webpack_require__(252);
  ...
  return _c('div', [(_vm.showSubRoute) ? _c('router-view') : _c('div', {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function(props) {
        ...
        }, [_vm._v("编辑活动")])], 1), _vm._v(" "), (props.row.is_lego == 0 || (props.row.is_lego == 1 && _vm.isAdmin)) ? _c('el-dropdown-item', {
          attrs: {
            "divided": ""
          }
        }, [_c('router-link', {
        ...
        }, [_vm._v("规则配置")])], 1) : _vm._e(), _vm._v(" "), (_vm.deploy) ? _c('el-dropdown-item', {
          attrs: {
            "divided": ""
          }
        }, [_c('div', {
