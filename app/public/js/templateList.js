...
Component.options.__file = "C:\\jyb\\jyb_git\\lego_manage\\app\\web\\pages\\template\\list\\listApp.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-762b51c3", Component.options)
  } else {
    hotAPI.reload("data-v-762b51c3", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    queryFilterList: function queryFilterList(refreshPage) {
      ...
      __WEBPACK_IMPORTED_MODULE_0_api_api_act_params__["d" /* queryGetComponentTemplate */](this.queryData).then(function (jsonData) {
    ...
    cancleAddTpl: function cancleAddTpl() {
      // TODO 恢复对象本来的值
      this.dialogVisible = false;
    },
    confirmAddTpl: function confirmAddTpl(formName) {
      var _this2 = this;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [(_vm.showSubRoute) ? _c('router-view') : _c('div', {
  ...
  }), _vm._v("新增模板")])])], 1)], 1), _vm._v(" "), _c('el-table', {
    directives: [{
      name: "loading",
      rawName: "v-loading",
    ...
    model: {
      value: (_vm.templateData.remark),
      callback: function($$v) {
        _vm.$set(_vm.templateData, "remark", $$v)
      },
      expression: "templateData.remark"
    }
    ...
    model: {
      ...
      callback: function($$v) {
        _vm.$set(_vm.templateData, "name", $$v)
      },
    ...
    model: {
      value: (_vm.templateData.com_id),
      callback: function($$v) {
        _vm.$set(_vm.templateData, "com_id", $$v)
      },
      expression: "templateData.com_id"
    }
  })], 1), _vm._v(" "), _c('el-form-item', [_c('el-button', {
    attrs: {
      "size": "small"
    ...
    on: {
      "click": function($event) {
        _vm.confirmAddTpl('templateData')
      }
    }
  }, [_vm._v("确 定")])], 1)], 1)], 1)], 1)
},staticRenderFns: []}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-762b51c3", module.exports)
  }
}
