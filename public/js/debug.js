...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__app_vue__ = __webpack_require__(317);
  ...
  install: function install(el, Vue) {
    ...
    return {
      ...
      on: function on() {
        ...
        (_app$$children$ = app.$children[0]).$on.apply(_app$$children$, arguments);
      }
    };
  }
};
...
Component.options.__file = "C:\\jyb\\jyb_git\\lego_manage\\web\\pages\\debug\\app.vue"
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_postmate__ = __webpack_require__(320);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_ace_editor_vue__ = __webpack_require__(321);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__helper__ = __webpack_require__(324);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__jyb_lego_util__ = __webpack_require__(325);
...
Component.options.__file = "C:\\jyb\\jyb_git\\lego_manage\\web\\components\\ace-editor.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("样式代码：")]), _vm._v(" "), _c('ace-editor', {
    ...
    staticClass: "debug-editor__title"
  }, [_vm._v("脚本代码：")]), _vm._v(" "), _c('ace-editor', {
    staticClass: "debug-editor",
    attrs: {
